...
import { playerConfig, playerAttrEffect } from '@/core/data/player'
import { weatherConfig } from '@/core/data/weather'
import type { PlayerAttributes, AttributeEffect, PlayerAttributeEffectConfig } from '@/shared/types/player.types'
import type { DeathReason } from '@/shared/types/game.types'
import { isInRange } from '@/shared/utils/math/range'
