...
import type { PlayerState, PlayerAttributes } from '@/shared/types/player.types'
import type { BuildingCost } from '@/shared/types/building.types'
import type { FoodEffect, MedicineEffect, BuffEffect } from '@/shared/types/item.types'
...
import { checkDeathOnAttributeChange, handleDeath } from '@/shared/utils/game/deathCheck'
