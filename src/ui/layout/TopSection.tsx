...
import { cocosToCssPosition } from '@/shared/utils/ui/position'
import { Sprite } from '@/shared/components/sprites/Sprite'
import { StatusButton, AttrButton, LogBar } from '@/shared/components/common'
import { attributeWarningRanges } from '@/core/data/attributeWarningRanges'
...
export function TopSection({ testLogs = [] }: TopSectionProps = {}) {
  ...
  return (
    <div className="absolute" style={bgStyle} data-test-id="topbar-bg" data-test-label="TopSection Background" data-test-position>
      {/* Background sprite */}
      <Sprite 
        atlas="ui" 
